...
function search(keyword){
  ...
  //   jsonp_res = resolve;
  //   req.send("http://polaris-bear.lolipop.jp/testserver/json2jsonp.php?s=" + encodeURIComponent(keyword) + "&callback=jsonp_callback").then(res => {
  //     console.log(res);
  //   });
  });
}
